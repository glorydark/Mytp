...
public class GuiListener implements Listener {
    ...
    private void formWindowModalOnClick(Player p, FormWindowModal modal, GuiType guiType) {
        if(modal.getResponse() == null){ return; }
        ...
        if(sender == null){ p.sendMessage(getLang("Tips", "player_undefined")); return; }
        switch (guiType){
    ...
    private void formWindowSimpleOnClick(Player p, FormWindowSimple simple, GuiType guiType) {
        ...
        switch (guiType) {
            ...
            case TeleportInitiativeMenuForFree:
                ...
                if(MainClass.checktrust(p, false) || bool){ MainClass.tp(p,selectedp); return; }
        ...
        case WarpsSettingManageMenu:
            ...
            case TeleportPassiveMenuForFree:
                ...
                if(MainClass.checktrust(p, false) || bool){ MainClass.tp(selectedp,p); return; }
